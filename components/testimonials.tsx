...
const testimonials = [
  {
    id: 1,
    name: "Saurabh Vasant Muley",
    role: "Senior Principal Technology Architect",
    company: "Infosys Ltd.",
    image: "/saurabh.png?height=80&width=80",
    rating: 5,
    text: "Yet to be added",
  },
  {
    id: 2,
    name: "Chander Mohan Bhargava",
    role: "Principal Consultant",
    company: "Infosys Ltd.",
    image: "/chander.png?height=80&width=80",
    rating: 5,
    text: "Yet to be added",
  },
  {
    id: 3,
    name: "Poonam Nitesh Ghadge",
    role: "Senior Technology Architect",
    company: "Infosys Ltd.",
    image: "/poonam.png?height=80&width=80",
    rating: 5,
    text: "Yet to be added",
  },
  {
    id: 4,
    name: "Gopinath Ratinakali",
    role: "Project Manager",
    company: "Infosys Ltd.",
    image: "/gopi.png?height=80&width=80",
    rating: 5,
    text: "Yet to be added",
  },
]
